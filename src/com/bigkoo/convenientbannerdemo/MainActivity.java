...
public class MainActivity extends Activity implements
	...
	private List<ADInfo> networkImages = new ArrayList<ADInfo>();
	...
	private void initViews() {
		...
		transformerArrayAdapter = new ArrayAdapter(this,
...
//		 .setOnPageChangeListener(this);监听翻页事件
		...
		for (int i = 0; i < images.length; i++) {
			...
			adInfo.setUrl(images[i]);
			adInfo.setContent("image "+i);
			networkImages.add(adInfo);
		}
	...
	private void loadTestDatas() {
		...
		transformerList.add(Transformer.BackgroundToForegroundTransformer
				.getClassName());
		...
		transformerList.add(Transformer.FlipHorizontalTransformer
				.getClassName());
		transformerList.add(Transformer.FlipVerticalTransformer.getClassName());
		transformerList.add(Transformer.ForegroundToBackgroundTransformer
				.getClassName());
	...
	public void onPageSelected(int position) {
		Toast.makeText(this, "监听到翻到第" + position + "了", Toast.LENGTH_SHORT)
				.show();
	}
	...
	public void onItemClick(int position) {
		Toast.makeText(this, "点击了第" + position + "个", Toast.LENGTH_SHORT)
				.show();
	}
}
