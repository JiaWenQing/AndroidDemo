...
/**
 * Created by Sai on 15/8/13. 这个是RecyclerView配合ConvenientBanner作为header的例子
 * 有issue反馈说RecyclerView刷新会出现空白图片，于是写了这个例子进行测试，也提供给对RecyclerView使用不熟悉的开发者进行参考吧。
 */
public class ADRecyclerViewDemo extends Activity implements
	...
	private void initViews() {
		...
		convenientBanner = (ConvenientBanner) LayoutInflater.from(this)
				.inflate(R.layout.adapter_header_cb, null);
